...
import { EditWorkspaceForm } from "@/app/main/workspace/(components)/dialog/edit/edit-workspace-form";
...
import { EditActionPlanForm } from "@/app/main/example-action-plans/(components)/dialog/edit/edit-dialog-form";
